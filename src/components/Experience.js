        ...
        <ul className="timeline">
          <li className="timeline-event">
            ...
            <div className="timeline-event-copy">
              ...
              <h3>Software Developer | Valstybinė Ligonių Kasa</h3>
              <p>
          ...
          <li className="timeline-event">
            ...
            <div className="timeline-event-copy">
              ...
              <p>
                  ...
                  I gained valuable experience working with databases, collaborating with
                  other team members and gained knowledge about the entire software development
                  life cycle.
              </p>
            </div>
          </li>
